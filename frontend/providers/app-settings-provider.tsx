...
const translations: Record<LanguageCode, Record<string, string>> = {
  en: {
    ...
    timeline_description:
      "Share updates, media, and conversations from one place.",
    ...
    create_post_screen_description:
      "Publish a new post with text, pictures, video, or audio.",
    content: "Content",
  ...
  ar: {
    ...
    timeline_description: "شارك التحديثات والوسائط والمحادثات من مكان واحد.",
    ...
    create_post_screen_description: "انشر منشوراً جديداً مع نص أو صور أو فيديو أو صوت.",
    content: "المحتوى",
